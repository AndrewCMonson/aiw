...
`,
    ...
    {
        slug: "context_sync",
        filename: "context_sync.md",
        contents: `# Context sync → update \`docs/PROJECT_CONTEXT.md\` from \`REPO_CONTEXT.md\`
...
|------|---------|-----------------|
| \`docs/PROJECT_CONTEXT.md\` | Authoritative project context. How the project is *meant* to work. Updated via PRs, reviewed by lead developers. | Yes |
